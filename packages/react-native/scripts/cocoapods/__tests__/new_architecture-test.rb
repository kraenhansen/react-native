...
class NewArchitectureTests < Test::Unit::TestCase
    ...
    def test_modifyFlagsForNewArch_whenOnOldArch_doNothing
        ...
        # Assert
        assert_equal("$(inherited) -DFOLLY_NO_CONFIG -DFOLLY_MOBILE=1 -DFOLLY_USE_LIBCPP=1 -DFOLLY_CFG_NO_COROUTINES=1 -DFOLLY_HAVE_CLOCK_GETTIME=1 -Wno-comma -Wno-shorten-64-to-32", first_xcconfig.attributes["OTHER_CPLUSPLUSFLAGS"])
        assert_equal(["a/path/First.xcconfig"], first_xcconfig.save_as_invocation)
        assert_equal("$(inherited) -DFOLLY_NO_CONFIG -DFOLLY_MOBILE=1 -DFOLLY_USE_LIBCPP=1 -DFOLLY_CFG_NO_COROUTINES=1 -DFOLLY_HAVE_CLOCK_GETTIME=1 -Wno-comma -Wno-shorten-64-to-32", second_xcconfig.attributes["OTHER_CPLUSPLUSFLAGS"])
        assert_equal(["a/path/Second.xcconfig"], second_xcconfig.save_as_invocation)
        assert_equal("$(inherited) -DFOLLY_NO_CONFIG -DFOLLY_MOBILE=1 -DFOLLY_USE_LIBCPP=1 -DFOLLY_CFG_NO_COROUTINES=1 -DFOLLY_HAVE_CLOCK_GETTIME=1 -Wno-comma -Wno-shorten-64-to-32", react_core_debug_config.build_settings["OTHER_CPLUSPLUSFLAGS"])
        assert_equal("$(inherited) -DFOLLY_NO_CONFIG -DFOLLY_MOBILE=1 -DFOLLY_USE_LIBCPP=1 -DFOLLY_CFG_NO_COROUTINES=1 -DFOLLY_HAVE_CLOCK_GETTIME=1 -Wno-comma -Wno-shorten-64-to-32", react_core_release_config.build_settings["OTHER_CPLUSPLUSFLAGS"])
    ...
    def test_modifyFlagsForNewArch_whenOnNewArchAndIsRelease_updateFlags
        ...
        assert_equal("$(inherited) -DRCT_NEW_ARCH_ENABLED=1 "+ folly_compiler_flags, first_xcconfig.attributes["OTHER_CPLUSPLUSFLAGS"])
        assert_nil(first_xcconfig.attributes["OTHER_CFLAGS"])
        assert_equal(["a/path/First.xcconfig"], first_xcconfig.save_as_invocation)
        assert_equal("$(inherited) -DRCT_NEW_ARCH_ENABLED=1 "+ folly_compiler_flags, second_xcconfig.attributes["OTHER_CPLUSPLUSFLAGS"])
        assert_nil(second_xcconfig.attributes["OTHER_CFLAGS"])
        assert_equal(["a/path/Second.xcconfig"], second_xcconfig.save_as_invocation)
        assert_equal("$(inherited) -DRCT_NEW_ARCH_ENABLED=1 "+ folly_compiler_flags, react_core_debug_config.build_settings["OTHER_CPLUSPLUSFLAGS"])
        assert_nil(react_core_debug_config.build_settings["OTHER_CFLAGS"])
        assert_equal("$(inherited) -DRCT_NEW_ARCH_ENABLED=1 "+ folly_compiler_flags, react_core_release_config.build_settings["OTHER_CPLUSPLUSFLAGS"])
    ...
    def test_installModulesDependencies_whenNewArchDisabledAndSearchPathsAndCompilerFlagsArePresent_itInstallDependenciesAndPreserveOtherSettings
        ...
        assert_equal("#{other_flags} \"$(PODS_ROOT)/boost\" \"$(PODS_ROOT)/Headers/Private/Yoga\" \"$(PODS_ROOT)/DoubleConversion\" \"$(PODS_ROOT)/fast_float/include\" \"$(PODS_ROOT)/fmt/include\" \"${PODS_CONFIGURATION_BUILD_DIR}/React-graphics/React_graphics.framework/Headers\" \"${PODS_CONFIGURATION_BUILD_DIR}/React-graphics/React_graphics.framework/Headers/react/renderer/graphics/platform/ios\" \"${PODS_CONFIGURATION_BUILD_DIR}/React-Fabric/React_Fabric.framework/Headers\" \"${PODS_CONFIGURATION_BUILD_DIR}/React-Fabric/React_Fabric.framework/Headers/react/renderer/components/view/platform/cxx\" \"${PODS_CONFIGURATION_BUILD_DIR}/React-FabricImage/React_FabricImage.framework/Headers\" \"${PODS_CONFIGURATION_BUILD_DIR}/ReactCommon/ReactCommon.framework/Headers\" \"${PODS_CONFIGURATION_BUILD_DIR}/ReactCommon/ReactCommon.framework/Headers/react/nativemodule/core\" \"${PODS_CONFIGURATION_BUILD_DIR}/React-NativeModulesApple/React_NativeModulesApple.framework/Headers\" \"${PODS_CONFIGURATION_BUILD_DIR}/React-RCTFabric/RCTFabric.framework/Headers\" \"${PODS_CONFIGURATION_BUILD_DIR}/React-utils/React_utils.framework/Headers\" \"${PODS_CONFIGURATION_BUILD_DIR}/React-featureflags/React_featureflags.framework/Headers\" \"${PODS_CONFIGURATION_BUILD_DIR}/React-debug/React_debug.framework/Headers\" \"${PODS_CONFIGURATION_BUILD_DIR}/React-ImageManager/React_ImageManager.framework/Headers\" \"${PODS_CONFIGURATION_BUILD_DIR}/React-rendererdebug/React_rendererdebug.framework/Headers\"", spec.pod_target_xcconfig["HEADER_SEARCH_PATHS"])
        assert_equal("c++20", spec.pod_target_xcconfig["CLANG_CXX_LANGUAGE_STANDARD"])
        assert_equal(
            [
                { :dependency_name => "React-Core" },
